            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    Możesz zeskanowac kod kreskowy opakowania z którym nie wiesz
                    co zrobić. Kod zostanie automatycznie sprawdzony w naszym
                    systemie.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    Nasza aplikacja korzysta ze sztuczej inteligencji zeby pomoc
                    ci znalezc miejsce dla twoich odpadów. Nie musisz się niczym
                    przejmować.
                  </Typography>
                </CardContent>
              </Card>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Card className={classes.card}>
                ...
                <CardContent className={classes.cardContent}>
                  ...
                  <Typography>
                    Mozesz recznie wprowadzic kod z opakowania jesli masz slaby
                    aparat w telefonie.
                  </Typography>
                </CardContent>
              </Card>
